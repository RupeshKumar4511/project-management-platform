...
const Sidebar = ({ isSidebarOpen, setIsSidebarOpen }) => {
    ...
    const menuItems = [
        { name: 'Dashboard', href: '/app/workspace', icon: LayoutDashboardIcon },
        { name: 'Projects', href: '/app/workspace/projects', icon: FolderOpenIcon },
        { name: 'Team', href: '/app/workspace/team', icon: UsersIcon },
    ]
            ...
            <div className='flex-1 overflow-y-scroll no-scrollbar flex flex-col'>
                <div>
                    <div className='p-4'>
                        ...
                        <NavLink to="/app/workspace/settings" className='flex w-full items-center gap-3 py-2 px-4 text-gray-800 dark:text-zinc-100 cursor-pointer rounded hover:bg-gray-50 dark:hover:bg-zinc-800/60 transition-all'>
                ...
                <NavLink to="/app/workspace/chatbot"  className="mx-5 my-4 text-xs font-medium text-gray-500 dark:text-zinc-400 uppercase tracking-wider">Ask to AI</NavLink>
