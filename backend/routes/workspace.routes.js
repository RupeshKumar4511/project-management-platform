...
router.route('/add-project-member').post(ensureWorkspaceUser, restrictTo(["org:admin", "org:member"]), checkSchema(updateProjectMemberSchema), schemaValidation, addMemberToProject)
